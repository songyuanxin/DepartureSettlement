    ...
    public SendMsgRes sendDirectly(Map<String,List<ImportDataDto>> storeDirectMap, String isReturn) {
        ...
        for(String direct:storeDirectMap.keySet()){
            ...
            if (data.hasNext()){
                ...
                String splicing = "离司结算审核提醒:\n您收到了"+ quitpernr.substring(0, quitpernr.length()-1) + "的离司结算申请" + "<a href=\"http://localhost:8080/approve/#/pages/index/directly/storeApproval?pernr="+direct.substring(0,6) + "\">"+"【审批入口】</a>";
